...
void readKeypad()
{
  ...
  if (keypressed == '#')
    {
      guess = code;
      if (guess != "3141" && guess != "3467" && guess != "374" && guess != "2873")
        {
          lcd.setCursor(0,0);
          lcd.print("Incorrect guess");
          lcd.setCursor(0,1);
          lcd.print("Try Again!");
          delay(1500);
          lcd.clear();
...
if (guess == "3141") //The code from the orbital game
{
  ...
  pixels.setPixelColor(1, pixels.Color(0,255,0));//green for activated
  pixels.setPixelColor(2, pixels.Color(0,255,0));//cyan for tube 1
...
if (guess == "3467")  // code from the ?? puzzle
{
  flag_b = 1;
  pixels.setPixelColor(6, pixels.Color(255,255,0));//yellow for tube 2
  ...
  pixels.setPixelColor(10, pixels.Color(0,255,0)); //green for activated 
  pixels.setPixelColor(11, pixels.Color(0,0,0)); 
  pixels.show();   // Send the updated pixel colors to the hardware.
}
//if correct for vile #3, then change state of lights and set flag
if (guess == "374") //code from puzzle ??
{
  flag_c = 1;
  pixels.setPixelColor(12, pixels.Color(0,0,0));
  pixels.setPixelColor(13, pixels.Color(0,255,0));//green for activated
  pixels.setPixelColor(14, pixels.Color(0,0,255));//blue for tube 3
...
{
  flag_d = 1;
  pixels.setPixelColor(18, pixels.Color(255,0,255)); // magentafor tube 4
  pixels.setPixelColor(19, pixels.Color(255,0,255));
  pixels.setPixelColor(20, pixels.Color(255,0,255));
  pixels.setPixelColor(21, pixels.Color(255,0,255));
  pixels.setPixelColor(22, pixels.Color(0,255,0)); //green for activated 
